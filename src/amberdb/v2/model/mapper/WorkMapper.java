...
public class WorkMapper implements ResultSetMapper<Work> {
    ...
    public Work map(int index, ResultSet r, StatementContext ctx) throws SQLException {
        return new Work(r.getInt("id"),
                ...
                r.getString("additionalContributor"),
                ...
                r.getString("publicationCategory"),
                r.getString("reorderType"),
                r.getString("immutable"),
                r.getString("copyrightPolicy"),
                r.getString("hasRepresentation"),
                ...
                r.getString("rights"),
                r.getString("genre"),
                r.getString("deliveryUrl"),
                r.getString("imageServerUrl"),
                r.getString("recordSource"),
                r.getString("sheetCreationDate"),
                r.getString("sheetName"),
                r.getString("creator"),
                r.getString("creatorStatement"),
                r.getString("additionalCreator"),
                r.getString("folderType"),
                r.getString("folderNumber"),
                r.getString("eventNote"),
                r.getString("notes"),
                r.getString("publicNotes"),
                r.getString("findingAidNote"),
                r.getBoolean("interactiveIndexAvailable"),
                r.getString("startChild"),
                ...
                r.getString("edition"),
                r.getString("reorder"),
                r.getString("additionalSeries"),
                r.getString("constraint1"),
                r.getString("parentConstraint"),
                r.getString("catalogueUrl"),
                ...
                r.getString("html"),
                r.getString("preservicaId"),
                r.getString("redocworksReason"),
                r.getBoolean("workCreatedDuringMigration"),
                r.getString("nextStep"),
                r.getInt("ingestJobId"),
