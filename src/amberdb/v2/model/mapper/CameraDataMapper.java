...
public class CameraDataMapper implements ResultSetMapper<CameraData> {
    ...
    public CameraData map(int index, ResultSet r, StatementContext ctx) throws SQLException {
        return new CameraData(r.getInt("id"),
                r.getInt("txn_start"),
                r.getInt("txn_end"),
                r.getString("extent"),
                ...
                r.getString("exposureTime"),
                r.getString("exposureFNumber"),
                r.getString("exposureMode"),
                r.getString("exposureProgram"),
                r.getString("isoSpeedRating"),
                r.getString("focalLength"),
                r.getString("lens"),
                r.getString("meteringMode"),
                r.getString("whiteBalance"),
                r.getString("fileSource"));
    }
}
