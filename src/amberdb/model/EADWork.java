...
public interface EADWork extends Work {
    ...
    /**
     * correspondenceIndex: provide summary of correspondence indexed to entities associated with this EADWork.
     */
    ...
    /**
     * componentLevel: the level within the collection for this EAD work. Example component levels include series,
     * subseries and file
     */
    ...
    /**
     * componentNumber: components are numbered within each level e.g. 1, and the numbering may include linkage to
     * parent e.g. 1.1
     */
    ...
    /**
     * This property is encoded as a JSON Array - You probably want to use getFolder() to get this property.
     */
    @Property("folder")
    public String getJSONFolder();

    /**
     * This property is encoded as a JSON Array - You probably want to use setFolder() to set this property.
     */
    @Property("folder")
    public void setJSONFolder(String folder);

    /**
     * This method handles the JSON deserialisation of the folder property. Each folder entry is returned as <folder
     * type>-<folder number>
     */
    @JavaHandler
    ...
    /**
     * This method handles the JSON serialisation of the folder property. Each folder input entry should be formatted as
     * <folder type>-<folder number>
     */
    @JavaHandler
