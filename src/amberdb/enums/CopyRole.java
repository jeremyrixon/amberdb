...
public enum CopyRole {
    ...
    SUMMARY_COPY("s", "Summary"),
    TRANSCRIPT_COPY("tr", "Transcript"),
    ...
    FINDING_AID__FILTERED_COPY("faf", "Finding aid filtered"),
    ...
    DIGITAL_DISTRIBUTION_COPY("d", "Disgital distribution"),
    ...
    QUICKTIME_FILE_1_COPY("rb3", "QuickTime file 1"),
    QUICKTIME_FILE_2_COPY("rb4", "QuickTime file 2"),
