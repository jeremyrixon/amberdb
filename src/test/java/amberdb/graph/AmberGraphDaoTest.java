...
public class AmberGraphDaoTest {
    ...
    public void updateEdgeOrder() throws Exception {
        ...
        Assert.assertEquals(1, e1.getProperty(AmberEdge.SORT_ORDER_PROPERTY_NAME));
        Assert.assertEquals(2, e2.getProperty(AmberEdge.SORT_ORDER_PROPERTY_NAME));
        Assert.assertEquals(3, e3.getProperty(AmberEdge.SORT_ORDER_PROPERTY_NAME));
        Assert.assertEquals(4, e4.getProperty(AmberEdge.SORT_ORDER_PROPERTY_NAME));
        ...
        Assert.assertEquals(4, e1.getProperty(AmberEdge.SORT_ORDER_PROPERTY_NAME));
        Assert.assertEquals(3, e2.getProperty(AmberEdge.SORT_ORDER_PROPERTY_NAME));
        Assert.assertEquals(2, e3.getProperty(AmberEdge.SORT_ORDER_PROPERTY_NAME));
        Assert.assertEquals(1, e4.getProperty(AmberEdge.SORT_ORDER_PROPERTY_NAME));
    }
