...
public class TagTest extends AbstractDatabaseIntegrationTest {
    ...
    public void basicTagTests() throws Exception { 
        ...
        Assert.assertTrue(tag2 instanceof Tag);
        Assert.assertEquals(tag.getName(), null);
        Assert.assertEquals(tag2.getName(), "tag2");
    ...
    public void nodeTaggingTests() throws Exception { 
        ...
        Assert.assertEquals(w.getTags().iterator().next(), tag);
        Assert.assertNotEquals(w.getTags().iterator().next(), tag2);
