...
public class DateParserTest {
    ...
    public void testAdditionalDateRangePattern() throws ParseException {
        ...
        Assert.assertEquals(expectedStartDate1, dateFormat.format(dates1.get(0)));
        Assert.assertEquals(expectedEndDate1, dateFormat.format(dates1.get(1)));
        ...
        Assert.assertEquals(expectedStartDate2, dateFormat.format(dates2.get(0)));
        Assert.assertEquals(expectedEndDate2, dateFormat.format(dates2.get(1)));
        ...
        Assert.assertEquals(expectedStartDate3, dateFormat.format(dates3.get(0)));
        Assert.assertEquals(expectedEndDate3, dateFormat.format(dates3.get(1)));
        ...
        Assert.assertEquals(expectedStartDate4, dateFormat.format(dates4.get(0)));
        Assert.assertEquals(expectedEndDate4, dateFormat.format(dates4.get(1)));
        ...
        Assert.assertEquals(expectedStartDate5, dateFormat.format(dates5.get(0)));
        Assert.assertEquals(expectedEndDate5, dateFormat.format(dates5.get(1)));
        ...
        Assert.assertEquals(expectedStartDate6, dateFormat.format(dates6.get(0)));
        Assert.assertEquals(expectedEndDate6, dateFormat.format(dates6.get(1)));
        ...
        Assert.assertEquals(expectedStartDate7, dateFormat.format(dates7.get(0)));
        Assert.assertEquals(expectedEndDate7, dateFormat.format(dates7.get(1)));
        ...
        Assert.assertEquals(expectedStartDate8, dateFormat.format(dates8.get(0)));
        Assert.assertEquals(expectedEndDate8, dateFormat.format(dates8.get(1)));
        ...
        Assert.assertEquals(expectedStartDate9, dateFormat.format(dates9.get(0)));
        Assert.assertEquals(expectedEndDate9, dateFormat.format(dates9.get(1)));
    }
    ...
    public void testCircaDateRangePattern() throws ParseException {
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");
        Assert.assertEquals(expectedStartDate, dateFormat.format(dates.get(0)));
        Assert.assertEquals(expectedEndDate, dateFormat.format(dates.get(1)));
    ...
    public void testIndivDate() throws ParseException {
        ...
        Assert.assertEquals(expectedStartDate, dateFormat.format(dateRange.get(0)));
        Assert.assertEquals(expectedEndDate, dateFormat.format(dateRange.get(1)));
    }
    ...
    public void testBulkDateRangePattern() throws ParseException {
        ...
        Assert.assertEquals(expectedFromDate, dateFmt.format(dateRange.get(0)));
        Assert.assertEquals(expectedToDate, dateFmt.format(dateRange.get(1)));
        ...
        Assert.assertEquals(expectedFromDate1, dateFmt.format(dateRange1.get(0)));
        Assert.assertEquals(expectedToDate1, dateFmt.format(dateRange1.get(1)));
    }
    ...
    public void testDateRangePattern() throws ParseException {
        ...
        for (String dateRangeExpr : testDateRangeExprs) {
            ...
            if (dateRangeExpr == null || dateRangeExpr.trim().isEmpty())
                Assert.assertNull(dateRange);
            else {
                if (dateRange.isEmpty()) {
                    boolean isFromDate = true;
                    Date fromDate = DateParser.parseDate(dateRangeExpr, isFromDate);
                    Assert.assertEquals(dateFmt.format(expectedFromDate.get(i)), dateFmt.format(fromDate));
                } else {
                    if (expectedFromDate.get(i) == null) {
                        Assert.assertNull(dateRange.get(0));
                    } else {
                        if (dateRange.get(0) == null) {
                            Assert.assertEquals(dateFmt.format(expectedFromDate.get(i)), dateFmt.format(dateRange.get(0)));
                        }
                    }

                    if (expectedToDate.get(i) == null) {
                        Assert.assertNull(dateRange.get(1));
                    } else {
                        if (dateRange.get(1) != null) {
                            Assert.assertEquals(dateFmt.format(expectedToDate.get(i)), dateFmt.format(dateRange.get(1)));
                        }
                    }
                }
            }
