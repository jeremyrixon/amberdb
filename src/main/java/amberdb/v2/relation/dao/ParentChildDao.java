...
public abstract class ParentChildDao {
    ...
    @SqlQuery("select * from work where id = :id limit :start, :num")
    public abstract List<ParentChild> getChildren(@Bind("id") Long id, @Bind("start") int start, @Bind("num") int num);
