...
public class AmberGraphSpecialPersistenceTest {
    ...
    public void testPersistVertex() throws Exception {
        ...
        graph1.specialCommit("tester", "Persisting v1");
        ...
        graph2.specialCommit("tester","update v2 and connector");
