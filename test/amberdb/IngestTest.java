...
public class IngestTest {
    ...
    private static AmberDb identifyWorks() throws IOException {
        try (AmberDb amberDb = new AmberDb()) {
            ...
            Section auto1 = amberDb.addSection(12345L);
    ...
    public void testQAWorks() {
        ...
        for (Long workId: job.getWorks()) {
            qaWork(job, dao.findSection(workId));
        }
    ...
    public void testFixLabel() {
        ...
        Page page7 = section.getPage(6);
        page7.setTitle("III");

        dao.commit();
    }
   
    private void qaWork(JobMockup job, Section section) {
