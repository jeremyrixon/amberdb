...
public class CopyRoleTest {
    ...
    public void validateCopyRoleEnum() {
        ...
        assertEquals(230,CopyRole.FINDING_AID_1_COPY.ord());
        assertEquals(240,CopyRole.FINDING_AID_2_COPY.ord());
        assertEquals(250,CopyRole.FINDING_AID_3_COPY.ord());
        assertEquals(260,CopyRole.FINDING_AID_4_COPY.ord());
        assertEquals(270,CopyRole.FINDING_AID_5_COPY.ord());
        assertEquals(280,CopyRole.FINDING_AID_6_COPY.ord());
        assertEquals(290,CopyRole.FINDING_AID_7_COPY.ord());
        assertEquals(300,CopyRole.FINDING_AID_8_COPY.ord());
        assertEquals(310,CopyRole.FINDING_AID_9_COPY.ord());
        assertEquals(320,CopyRole.FINDING_AID_10_COPY.ord());
        assertEquals(330,CopyRole.FLIGHT_DIAGRAM_COPY.ord());
        assertEquals(340,CopyRole.IMAGE_PACKAGE.ord());
        assertEquals(350,CopyRole.INDEX_COPY.ord());
        assertEquals(360,CopyRole.LIST_COPY.ord());
        assertEquals(370,CopyRole.MICROFORM_COPY.ord());
        assertEquals(380,CopyRole.OCR_METS_COPY.ord());
        assertEquals(390,CopyRole.OCR_ALTO_COPY.ord());
        assertEquals(400,CopyRole.OCR_JSON_COPY.ord());
        assertEquals(410,CopyRole.PAPER_SUMMARY.ord());
        assertEquals(420,CopyRole.PAPER_TRANSCRIPT.ord());
        assertEquals(430,CopyRole.PRINT_COPY.ord());
        assertEquals(440,CopyRole.PRODUCTION_MATERIAL.ord());
        assertEquals(450,CopyRole.QUICKTIME_FILE_1_COPY.ord());
        assertEquals(460,CopyRole.QUICKTIME_FILE_2_COPY.ord());
        assertEquals(470,CopyRole.QUICKTIME_REF_1_COPY.ord());
        assertEquals(480,CopyRole.QUICKTIME_REF_2_COPY.ord());
        assertEquals(490,CopyRole.QUICKTIME_REF_3_COPY.ord());
        assertEquals(500,CopyRole.QUICKTIME_REF_4_COPY.ord());
        assertEquals(510,CopyRole.REAL_MEDIA_FILE_COPY.ord());
        assertEquals(520,CopyRole.REAL_MEDIA_REF_COPY.ord());
        assertEquals(530,CopyRole.RTF_TRANSCRIPT.ord());
        assertEquals(540,CopyRole.SPECIAL_DELIVERY_COPY.ord());
        assertEquals(550,CopyRole.STRUCTURAL_MAP_COPY.ord());
        assertEquals(560,CopyRole.THUMBNAIL_COPY.ord());
        assertEquals(570,CopyRole.TIME_CODED_SUMMARY.ord());
        assertEquals(580,CopyRole.TIME_CODED_TRANSCRIPT_COPY.ord());
        assertEquals(590,CopyRole.VIEW_COPY.ord());
        assertEquals(60,CopyRole.values().length);
    }
