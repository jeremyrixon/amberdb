...
sess = AmberDbFactory.openAmberDb(dbUrl, dbUser, dbPassword, rootPath)
collection = sess.findWork(179720227L)
bookBBill = sess.findWork(179722129L)
workFrontCover = sess.findWork(179722445L)
workTitlePage = sess.findWork(179722746L)
